...
If you are naming the current GitHub repository release, use `Vibe Coding Protocols v0.9.1`.
...
If you skipped `.vcp/integrations.json`, dashboard build, metrics board, plugin metadata validation, or the MVP-to-Launch path/workflow/checklist surfaces, your review is not complete for `v0.9.1`.
