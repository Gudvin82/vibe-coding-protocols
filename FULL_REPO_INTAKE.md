...
If you skipped `.vcp/integrations.json`, dashboard build, metrics board, plugin metadata validation, or the MVP-to-Launch path/workflow/checklist surfaces, your review is not complete for `v0.8.5`.
