...
If the user only shared a link to VCP and asked what to take, start with `../TAKE_THIS_FIRST.md`.
...
- [reports/vcp-adoption-decision-report.md](./reports/vcp-adoption-decision-report.md)
...
- [reports/daily-error-triage-report.md](./reports/daily-error-triage-report.md)
- [reports/backlog-update-report.md](./reports/backlog-update-report.md)
...
- [prompts/adopt-vcp-from-link.md](./prompts/adopt-vcp-from-link.md)
