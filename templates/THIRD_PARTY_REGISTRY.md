...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Example package | npm package | https://github.com/example/repo | Example Maintainer | v1.2.3 | MIT | no postinstall | no production secrets | unknown | not verified | no | repo and release page reviewed | 2026-05-26 | 2026-06-26 | monthly | yes | engineering | security owner approves emergency bump | not run | low | none |
