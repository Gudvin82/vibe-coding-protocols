...
<body>
  <main>
    ...
    <div class=\"grid\">
      ...
      <section class=\"card\"><h2>Readiness</h2><p>Status: <code>{html.escape(metrics['release_readiness']['status'])}</code><br>Cards: <code>{metrics['cards_count']}</code><br>Benchmarks: <code>{metrics['benchmark_scenario_count']}</code></p></section>
