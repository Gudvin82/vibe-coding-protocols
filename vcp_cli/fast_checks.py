...
FAST_REQUIRED_FILES = [
    ...
    "templates/reports/review-diff-report.md",
    "templates/reports/score-badge-report.md",
    ...
    "case-studies/sanitized/ai-generated-mvp-hardening/README.md",
    "case-studies/sanitized/spec-retrofit-existing-project/README.md",
    ...
    "benchmarks/ai-adoption/scenarios/review-diff-risk-routing.json",
    "benchmarks/ai-adoption/scenarios/score-badge-generation.json",
    "benchmarks/ai-adoption/scenarios/github-pr-gate-workflow.json",
    "benchmarks/ai-adoption/scenarios/foundation-product-delivery-lifecycle.json",
    "benchmarks/ai-adoption/scenarios/spec-kit-bridge-positioning.json",
    "benchmarks/ai-adoption/scenarios/platform-status-honesty.json",
    "benchmarks/ai-adoption/scenarios/docs-tone-no-overclaim.json",
    "case-studies/README.md",
...
CORE_SMOKE_COMMANDS = [
    ...
    ["route", "--profile", "spec-first", "--json"],
    ["adopt", "--pack", "third-party-api", "--dry-run", "--json"],
    ["adopt", "--pack", "public-growth", "--dry-run", "--json"],
    ["adopt", "--pack", "spec-first", "--dry-run", "--json"],
    ["index", "validate", "--json"],
    ["index", "show", "--json"],
    ["index", "search", "production", "--json"],
    ["cards", "list", "--json"],
    ["cards", "list", "--recommended", "--json"],
    ["cards", "list", "--maturity", "stable", "--json"],
    ["cards", "list", "--platform", "codex-cli", "--json"],
    ["cards", "validate", "--json"],
    ["cards", "show", "production-hardening", "--json"],
    ["spec", "validate", "--json"],
    ["spec", "template", "prd"],
    ["spec", "summary", "--json"],
    ["spec", "depth", "--task", "copy-only docs fix", "--json"],
    ["spec", "skip-check", "--task", "copy-only docs fix", "--json"],
    ["spec", "questions", "--idea", "build a customer portal", "--json"],
    ["spec", "retrofit", "--scope", "auth", "--dry-run", "--json"],
    ["spec", "freshness", "--json"],
    ["preset", "list", "--json"],
    ["preset", "show", "solo-founder", "--json"],
    ["preset", "validate", "--json"],
    ["workflow", "list", "--json"],
    ["workflow", "validate", "--json"],
    ["workflow", "show", "production-hardening", "--json"],
    ["workflow", "search", "hardening", "--json"],
    ["diagnose", "--json"],
    ["diagnose", "--profile", "production", "--json"],
...
def validate_version_consistency(root: Path) -> dict[str, Any]:
    ...
    checks = [
        ...
        (root / "docs/versioning.md", f"Stable methodology reference `{method_ver}`", "docs/versioning methodology reference"),
