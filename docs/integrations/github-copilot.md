...
- route protocols and templates you want Copilot Chat to use as context.
...
Do not assume full autonomous agent behavior.
Use repository instructions and focused prompts rather than implying native VCP command execution.
