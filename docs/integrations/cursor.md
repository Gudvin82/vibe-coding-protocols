...
- `templates/AGENTS.cursor.md` if present;
...
Cursor users often combine `.cursorrules` with local `AGENTS.md`.
Keep route selection explicit so the IDE does not over-read the whole repository.
