...
Repository support docs live here.

## Included

- [`attribution.md`](./attribution.md) — attribution notes and independent review clarification
- [`public-vs-private-docs.md`](./public-vs-private-docs.md) — what should stay private or sanitized
...
- [`security-operations.md`](./security-operations.md) — recurring security hygiene overview
- [`secret-rotation-and-storage.md`](./secret-rotation-and-storage.md) — secret lifecycle guidance
- [`safe-update-workflow.md`](./safe-update-workflow.md) — safer update process for dependencies and integrations
- [`token-aware-code-discovery.md`](./token-aware-code-discovery.md) — read-order and scoped discovery guidance
