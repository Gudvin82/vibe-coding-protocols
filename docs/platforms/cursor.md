...
Ask Cursor to use route selection and dry-run adoption before making edits.

## What not to ask

Do not ask Cursor to overwrite project-specific files blindly or pretend an official plugin exists.
