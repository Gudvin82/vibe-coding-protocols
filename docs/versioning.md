...
- Repository package `v0.6.6` — GitHub toolkit packaging, CLI, npm wrapper, manifests, cards, benchmarks, examples, CI, and docs.
...
`v0.6.6` strengthens the New Project Track and Existing Project Track with spec foundation, spec quality gate, AI MVP hardening, architecture drift checks, and release-readiness control.
