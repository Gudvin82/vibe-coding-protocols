...
- Repository package `v0.4.3` — GitHub toolkit packaging,
  scripts,
  examples,
  CI
  and docs.
...
Current repository package: `v0.4.3`.
Current web methodology: `v1.4`.

Experimental wrappers,
integration docs,
public-site templates
and extension skeletons in `v0.4.3` do not mean those surfaces are mature products.
They mean documented and contributor-ready surfaces exist.
