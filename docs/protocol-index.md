...
| `/loop-code-review` | Review | Meaningful AI-generated changes need acceptance before next task, merge or release | You need a full security audit or broad refactor | active diff, validation output, reviewer path | review plus validation green | `templates/reports/code-review-report.md` | medium to high |
