...
| Meaningful AI-generated changes already exist and must be accepted before moving on | [Post-Task Code Review](./protocols/review/post-task-code-review.md) | active diff + validation output | `/loop-code-review` |
...
- After meaningful AI-generated code changes, run Post-Task Code Review before starting the next feature.
