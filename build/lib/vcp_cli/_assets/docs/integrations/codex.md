...
- `templates/AGENTS.md`;
- maintenance command docs if you want named refactoring workflows.
...
Codex can use VCP as a route-first operating playbook.
Treat `/care-refactoring` and `/ui-refactoring` as documented workflows,
not as guaranteed native command surfaces.
