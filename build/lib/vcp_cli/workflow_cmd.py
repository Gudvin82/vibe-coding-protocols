...
def workflow_run_payload(
    ...
    *,
        ...
        step_results.append(
            {
                ...
                "reason": (
                    "Interactive workflow run in v0.8.4 is a safe preview surface and does not execute external actions."
    ...
    return {
        ...
        "plan": plan,
        "steps": step_results,
        "note": "workflow run is an interactive safe runner/planner. In v0.8.4 it previews only safe local VCP steps and never deploys, publishes, modifies files, or accesses secrets.",
    }
