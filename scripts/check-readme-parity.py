...
CHECKS = [
    ...
    ('platform positioning', ['Build with AI.\nControl what AI built.\nAdopt safely.\nShip with evidence.'], ['Создавайте с AI. Контролируйте то, что AI построил. Внедряйте безопасно. Запускайте с доказательствами.']),
    ...
    ('control platform links', ['docs/control-catalog.md', 'docs/change-intent.md', 'docs/starter-template-adoption.md', 'docs/agent-rule-profiles.md', 'docs/project-control-charter.md', 'docs/ecosystem-map.md', 'docs/ai-augmented-solo-squad-path.md'], ['docs/control-catalog.md', 'docs/change-intent.md', 'docs/starter-template-adoption.md', 'docs/agent-rule-profiles.md', 'docs/project-control-charter.md', 'docs/ecosystem-map.md', 'docs/ai-augmented-solo-squad-path.md']),
